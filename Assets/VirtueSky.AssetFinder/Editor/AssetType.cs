...
namespace VirtueSky.AssetFinder.Editor
{
    public class AssetType
    {
        ...
        internal static readonly AssetType[] FILTERS =
        {
            new("Scene", ".unity"),
            new("Prefab", ".prefab"),
            new("Model", ".3df", ".3dm", ".3dmf", ".3dv", ".3dx", ".c5d", ".lwo", ".lws",
                ".ma", ".mb",
                ".mesh", ".vrl", ".wrl", ".wrz", ".fbx", ".dae", ".3ds", ".dxf", ".obj", ".skp",
                ".max", ".blend"),
            new("Material", ".mat", ".cubemap", ".physicsmaterial"),
            new("Texture", ".ai", ".apng", ".png", ".bmp", ".cdr", ".dib", ".eps",
                ".exif", ".ico", ".icon",
            ...
            new("Video", ".asf", ".asx", ".avi", ".dat", ".divx", ".dvx", ".mlv", ".m2l",
                ".m2t", ".m2ts",
                ".m2v", ".m4e", ".m4v", "mjp", ".mov", ".movie", ".mp21", ".mp4", ".mpe", ".mpeg",
                ".mpg", ".mpv2",
                ".ogm", ".qt", ".rm", ".rmvb", ".wmv", ".xvid", ".flv"),
            new("Audio", ".mp3", ".wav", ".ogg", ".aif", ".aiff", ".mod", ".it", ".s3m",
                ".xm"),
            new("Script", ".cs", ".js", ".boo", ".h"),
            new("Text", ".txt", ".json", ".xml", ".bytes", ".sql"),
            new("Shader", ".shader", ".cginc"),
            new("Animation", ".anim", ".controller", ".overridecontroller", ".mask"),
            new("Unity Asset", ".asset", ".guiskin", ".flare", ".fontsettings", ".prefs"),
            new("Others") //
        };
