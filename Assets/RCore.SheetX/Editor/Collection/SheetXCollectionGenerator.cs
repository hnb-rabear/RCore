...
namespace RCore.SheetX.Editor
{
	...
	/// <summary>
	/// Emits the single data-only <c>SheetXDataCollections.g.cs</c>. Fields only: no runtime loading, no
	...
	{
		internal const string FileName = "SheetXDataCollections.g.cs";
		...
		{
			string folder = SheetXCollectionSettings.NormalizePath(settings?.collectionJsonFolder);
		...
		internal static string Emit(SheetXSettings settings, IReadOnlyList<SheetXCollectionGeneratedTable> tables)
		{
			...
			source.Append("// <auto-generated />").Append(NL);
			...
			bool hasNamespace = !string.IsNullOrWhiteSpace(settings?.collectionNamespace);
			string indent = hasNamespace ? T : "";
			if (hasNamespace)
			{
				source.Append("namespace ").Append(settings.collectionNamespace.Trim()).Append(NL);
