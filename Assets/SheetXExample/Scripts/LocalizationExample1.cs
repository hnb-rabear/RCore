namespace SheetXExample
{
	...
	public static class LocalizationExample1
	{
		...
		public static readonly Dictionary<string, string> LanguageFiles = new Dictionary<string, string>() {  { "english", "LocalizationExample1_english" }, { "spanish", "LocalizationExample1_spanish" }, { "japan", "LocalizationExample1_japan" }, { "chinese", "LocalizationExample1_chinese" }, { "korean", "LocalizationExample1_korean" }, { "thai", "LocalizationExample1_thai" }, };
		...
		private static void CreateClassContainsRefinedIds(List<string> pRefinedIds)
		{
			...
			string path = $"{directoryPath}/{nameof(LocalizationExample1)}RefinedIds.cs";
		...
		{
			string content = $"namespace {typeof(LocalizationExample1).Namespace}\n"
				+ "{\n"
				+ "\tusing System.Collections.Generic;\n"
				+ $"\tpublic class LocalizationExample1RefinedIds\n"
				+ "\t{\n"
				+ "\t\tpublic static readonly List<LocalizationExample1.ID> enumIds = new List<LocalizationExample1.ID> { ENUM_IDS };\n"
				+ "\t\tpublic static readonly List<int> intIds = new List<int> { INT_IDS };\n"
				+ "\t}\n"
				+ "}";
			return content;
		}
		[UnityEditor.MenuItem("Assets/Create/RCore/Localization/Refine LocalizationExample1 Ids")]
