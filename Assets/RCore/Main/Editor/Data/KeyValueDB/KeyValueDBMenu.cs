...
namespace RCore.Editor.Data.KeyValue
{
	...
	public static class KeyValueDBMenu
	{
		...
		[MenuItem("RCore/KeyValue Database/KeyValueDB Editor " + CTRL + "_" + ALT + "_m", priority = RMenu.GROUP_6 + 1)]
		...
		[MenuItem("RCore/KeyValue Database/Clear", priority = RMenu.GROUP_6 + 2)]
		...
		[MenuItem("RCore/KeyValue Database/Backup", priority = RMenu.GROUP_6 + 3)]
		...
		[MenuItem("RCore/KeyValue Database/Restore", priority = RMenu.GROUP_6 + 4)]
		...
		[MenuItem("RCore/KeyValue Database/Log", priority = RMenu.GROUP_6 + 5)]
