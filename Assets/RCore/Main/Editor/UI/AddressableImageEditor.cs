...
namespace RCore.Editor.UI
{
    ...
    public class AddressableImageInspector : UnityEditor.Editor
    {
        ...
        private void OnEnable()
        {
            ...
            // Runtime AddressableImage.OnValidate cannot call into this assembly, so capture happens here.
            if (m_Target != null)
                AddressableImageEditor.CaptureOrRefresh(m_Target, false);
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (image == null)
                ...
                EditorGUILayout.HelpBox("Image.sprite assigned but not captured yet. Click Set Addressable Asset.", MessageType.Warning);
            else if (image.sprite != null && hasReference)
