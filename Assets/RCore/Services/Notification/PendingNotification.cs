...
namespace RCore.Service
{
    ...
    public class PendingNotification
    {
        ...
        /// <remarks>
        /// <para>
        /// Only valid if the <see cref="NotificationsManager"/>'s <see cref="NotificationsManager.Mode"/>
        /// flag is set to <see cref="NotificationsManager.OperatingMode.RescheduleAfterClearing"/>.
        /// </para>
        /// <para>
