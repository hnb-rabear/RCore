	...
	internal static class SerializationTestData
	{
		...
		public sealed class ModelWithEnums
		{
			...
			public override bool Equals(object obj)
			{
				...
				return EnumDefaultByName == other.EnumDefaultByName && EnumAttributedByName == other.EnumAttributedByName && EnumByNumber == other.EnumByNumber;
			}
		...
		public sealed class CustomUser
		{
			...
			public override bool Equals(object obj)
			{
				...
				return HighScore == other.HighScore && Name == other.Name && Emails.SequenceEqual(other.Emails);
			}
			...
			: FirestoreConverter<CustomUserSetEmailsWithConverter>
		{
			public override CustomUserSetEmailsWithConverter FromFirestore(object value)
			{
				...
				return new CustomUserSetEmailsWithConverter
				{
		...
		internal struct CustomValueType : IEquatable<CustomValueType>
		{
			...
			public override bool Equals(object obj) => obj is CustomValueType && Equals((CustomValueType)obj);
			public bool Equals(CustomValueType other) => Name == other.Name && Value == other.Value;
			public override string ToString() => $"CustomValueType: {new { Name, Value }}";
		}
		...
		internal struct StructModel : IEquatable<StructModel>
		{
			...
			public override int GetHashCode() => Name.GetHashCode() + Value;
			public override bool Equals(object obj) => obj is StructModel model && Equals(model);
			public bool Equals(StructModel other) => Name == other.Name && Value == other.Value;
			public override string ToString() => $"StructModel: {new { Name, Value }}";
		}
	}
}